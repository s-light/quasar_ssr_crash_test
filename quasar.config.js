...
// https://www.npmjs.com/package/last-commit-log
const LCL = require("last-commit-log");
const lcl = new LCL(); // or `new LCL(dir)` dir is process.cwd() by default
const git_commit = lcl.getLastCommitSync();

const buildDate = new Date().getTime();

// https://new-docs.quasar.dev/quasar-cli-vite/handling-process-env#using-dotenv
